...
var (
	...
	//go:embed resources/supabase_edge_function_secrets/resource.tf
	EdgeFunctionSecretsResourceConfig string
	//go:embed resources/supabase_apikey/resource.tf
	ApiKeyResourceConfig string
	//go:embed ephemeral-resources/supabase_apikey/ephemeral-resource.tf
	ApiKeyEphemeralResourceConfig string
